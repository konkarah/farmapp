    ...
    <div>
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Set up double-entry accounting accounts</p>
          </div>
        </div>
      </header>
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="bg-white rounded-lg shadow p-12 text-center">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mb-3">Chart of Accounts</h2>
          <p className="text-gray-500 mb-2 max-w-lg mx-auto">Set up double-entry accounting accounts</p>
